        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-4">
          <div>
            ...
            <p className="mt-2 max-w-xl text-frost/70 text-sm">
              Explore {stations.length} live verified charging points across India. Click any charging station to project details and launch exact Google Maps navigation.
            </p>
          </div>
            ...
            <div className="lg:col-span-4 space-y-3.5 max-h-[680px] overflow-y-auto custom-scrollbar pr-1">
              <div className="flex items-center justify-between pb-1">
                <span className="text-xs font-bold text-frost">
                  {results.length} of {stations.length} live station{results.length === 1 ? "" : "s"} found
                </span>
